...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        # -- This part upto return final_answer handles the arrow going from thought to the final answer
        ...
        # NOTE - This implementation is really fragile it's really relying on the fact that the LLM is going to adhere to the format and to the scheme that we asked it for. In case the LLM does not adhere to the scheme or format, everything breaks
